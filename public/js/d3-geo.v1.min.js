...
!function (n, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("d3-array")) : "function" == typeof define && define.amd ? define(["exports", "d3-array"], t) : t((n = n || self).d3 = n.d3 || {}, n.d3)
}(this, function (n, t) {
    "use strict";
    ...
    function o(n, t, r) {
        var i = n.s = t + r, e = i - t, o = i - e;
        n.t = t - o + (r - e)
    }

    var u = 1e-6, c = 1e-12, a = Math.PI, l = a / 2, f = a / 4, s = 2 * a, p = 180 / a, h = a / 180, g = Math.abs,
        v = Math.atan, d = Math.atan2, E = Math.cos, y = Math.ceil, S = Math.exp, m = Math.log, M = Math.pow,
        x = Math.sin, _ = Math.sign || function (n) {
            return n > 0 ? 1 : n < 0 ? -1 : 0
        }, N = Math.sqrt, w = Math.tan;
    ...
    var G, T, k, F, H, I = r(), W = r(), B = {
        point: A, lineStart: A, lineEnd: A, polygonStart: function () {
    ...
    function Y(n, t) {
        var r = (n *= h) - k, i = r >= 0 ? 1 : -1, e = i * r, o = E(t = (t *= h) / 2 + f), u = x(t), c = H * u,
            a = F * o + c * E(e), l = c * i * x(e);
    ...
    var tn, rn, en, on, un, cn, an, ln, fn, sn, pn, hn, gn, vn, dn, En, yn, Sn, mn, Mn, xn, _n, Nn, wn, Rn, Cn,
        Pn = r(), An = {
            point: jn, lineStart: zn, lineEnd: bn, polygonStart: function () {
    ...
    function qn(n, t) {
        var r = J([n * h, t * h]);
        if (ln) {
            var i = Q(ln, r), e = Q([i[1], -i[0], 0], i);
            nn(e), e = Z(e);
            var o, u = n - un, c = u > 0 ? 1 : -1, a = e[0] * p * c, l = g(u) > 180;
    ...
    var Hn = {
        sphere: A, point: In, lineStart: Bn, lineEnd: Xn, polygonStart: function () {
    ...
    function Un(n, t) {
        n *= h;
        var r = E(t *= h), i = r * E(n), e = r * x(n), o = x(t),
    ...
    function Kn(n, t) {
        n *= h;
        var r = E(t *= h), i = r * E(n), e = r * x(n), o = x(t), u = Rn * o - Cn * e, c = Cn * i - wn * o,
            a = wn * e - Rn * i, l = N(u * u + c * c + a * a), f = C(l), s = l && -f / l;
    ...
    function it(n, t) {
        var r = E(n), i = x(n), e = E(t), o = x(t);

        function u(n, t) {
            var u = E(t), c = E(n) * u, a = x(n) * u, l = x(t), f = l * r + c * i;
            return [d(a * e - f * o, c * r - l * i), C(f * e + a * o)]
        }

        return u.invert = function (n, t) {
            var u = E(t), c = E(n) * u, a = x(n) * u, l = x(t), f = l * e - a * o;
    ...
    function gt(n, t) {
        var r = ht(t), i = t[1], e = x(i), o = [x(r), -E(r), 0], c = 0, p = 0;
        ...
        for (var h = 0, g = n.length; h < g; ++h) if (y = (v = n[h]).length) for (var v, y, S = v[y - 1], m = ht(S), M = S[1] / 2 + f, _ = x(M), N = E(M), w = 0; w < y; ++w, m = P, _ = j, N = q, S = R) {
            var R = v[w], P = ht(R), A = R[1] / 2 + f, j = x(A), q = E(A), z = P - m, b = z >= 0 ? 1 : -1, L = b * z,
                O = L > a, G = _ * j;
    ...
    function vt(n, r, i, e) {
        return function (o) {
            var u, c, a, l = r(o), f = ct(), s = r(f), p = !1, h = {
                point: g, lineStart: d, lineEnd: E, polygonStart: function () {
            ...
            function m() {
                ...
                var n, t, r, i, e = s.clean(), l = f.result(), h = l.length;
    ...
    var yt = vt(function () {
        ...
        var t, r = NaN, i = NaN, e = NaN;
        return {
            lineStart: function () {
                n.lineStart(), t = 1
            }, point: function (o, c) {
                var f = o > 0 ? a : -a, s = g(o - r);
    ...
    function St(n) {
        ...
        function c(n, r, i) {
            var e = [1, 0, 0], o = Q(J(n), J(r)), c = K(o, o), l = o[0], f = c - l * l;
            if (!f) return !i && n;
            var s = t * c / f, p = -t * l / f, h = Q(e, o), v = $(e, s);
            V(v, $(o, p));
            var d = h, E = K(v, d), y = K(d, d), S = E * E - y * (K(v, v) - 1);
            if (!(S < 0)) {
                var m = N(S), M = $(d, (-E - m) / y);
                if (V(M, v), M = Z(M), !i) return M;
                var x, _ = n[0], w = r[0], R = n[1], C = r[1];
                w < _ && (x = _, _ = w, w = x);
                var P = w - _, A = g(P - a) < u;
        ...
        return vt(o, function (n) {
            ...
            return {
                lineStart: function () {
                    ...
                    var v, d = [h, g], E = o(h, g), y = i ? E ? 0 : l(h, g) : E ? l(h + (h < 0 ? a : -a), g) : 0;
    ...
    function xt(n, r, i, e) {
        ...
        return function (u) {
            var a, f, s, p, h, g, v, d, E, y, S, m = u, M = ct(), x = {
            ...
            function N(t, u) {
                ...
                if (f && s.push([t, u]), y) p = t, h = u, g = c, y = !1, c && (m.lineStart(), m.point(t, u)); else if (c && E) m.point(t, u); else {
                    ...
                    !function (n, t, r, i, e, o) {
                        var u, c = n[0], a = n[1], l = 0, f = 1, s = t[0] - c, p = t[1] - a;
                        if (u = r - c, s || !(u > 0)) {
                            if (u /= s, s < 0) {
                                if (u < l) return;
                                u < f && (f = u)
    ...
    var _t, Nt, wt, Rt = r(), Ct = {
        sphere: A, point: A, lineStart: function () {
            Ct.point = At, Ct.lineEnd = Pt
        }, lineEnd: A, polygonStart: A, polygonEnd: A
    };
    ...
    function jt(n, t) {
        n *= h;
        var r = x(t *= h), i = E(t), e = g(n - _t), o = E(e), u = i * x(e), c = wt * r - Nt * i * o,
            a = Nt * r + wt * i * o;
    ...
    var zt = [null, null], bt = { type: "LineString", coordinates: zt };
    ...
    function Ut() {
        var n, r, i, e, o, c, a, l, f, s, p, h, v = 10, d = v, E = 90, S = 360, m = 2.5;
    ...
    var er = 1 / 0, or = er, ur = -er, cr = ur, ar = {
        point: function (n, t) {
            n < er && (er = n);
            n > ur && (ur = n);
            t < or && (or = t);
            t > cr && (cr = t)
        }, lineStart: A, lineEnd: A, polygonStart: A, polygonEnd: A, result: function () {
            var n = [[er, or], [ur, cr]];
            return ur = cr = -(or = er = 1 / 0), n
        }
    };
    var lr, fr, sr, pr, hr = 0, gr = 0, vr = 0, dr = 0, Er = 0, yr = 0, Sr = 0, mr = 0, Mr = 0, xr = {
        point: _r, lineStart: Nr, lineEnd: Cr, polygonStart: function () {
    ...
    zr.prototype = {
        _radius: 4.5, pointRadius: function (n) {
    ...
    function Yr(n, t, r) {
        return Xr(n, function (r) {
            var i = t[1][0] - t[0][0], e = t[1][1] - t[0][1],
                o = Math.min(i / (r[1][0] - r[0][0]), e / (r[1][1] - r[0][1])),
                u = +t[0][0] + (i - o * (r[1][0] + r[0][0])) / 2, c = +t[0][1] + (e - o * (r[1][1] + r[0][1])) / 2;
    ...
    function Jr(n, t, r) {
        return Xr(n, function (r) {
            var i = +t, e = i / (r[1][0] - r[0][0]), o = (i - e * (r[1][0] + r[0][0])) / 2, u = -e * r[0][1];
    ...
    function Kr(n, t, r) {
        return Xr(n, function (r) {
            var i = +t, e = i / (r[1][1] - r[0][1]), o = -e * r[0][0], u = (i - e * (r[1][1] + r[0][1])) / 2;
            n.scale(150 * e).translate([o, u])
        }, r)
    }

    Wr.prototype = {
        _radius: 4.5, _circle: Br(4.5), pointRadius: function (n) {
        ...
        constructor: Ur, point: function (n, t) {
    ...
    function $r(n, t) {
        return +t ? function (n, t) {
            function r(i, e, o, c, a, l, f, s, p, h, v, E, y, S) {
                var m = f - i, M = s - e, x = m * m + M * M;
                if (x > 4 * t && y--) {
                    var _ = c + h, w = a + v, R = l + E, P = N(_ * _ + w * w + R * R), A = C(R /= P),
                        j = g(g(R) - 1) < u || g(o - p) < u ? (o + p) / 2 : d(w, _), q = n(j, A), z = q[0], b = q[1],
                        L = z - i, O = b - e, G = M * L - m * O;
                    (G * G / x > t || g((m * L + M * O) / x - .5) > .3 || c * h + a * v + l * E < Vr) && (r(i, e, o, c, a, l, z, b, j, _ /= P, w /= P, R, y, S), S.point(z, b), r(z, b, j, _, w, R, f, s, p, h, v, E, y, S))
                }
            }

            return function (t) {
                var i, e, o, u, c, a, l, f, s, p, h, g, v = {
                    point: d, lineStart: E, lineEnd: S, polygonStart: function () {
    ...
    function ti(n, t, r, i) {
        var e = E(i), o = x(i), u = e * n, c = o * n, a = e / n, l = o / n, f = (o * r - e * t) / n,
            s = (o * t + e * r) / n;
    ...
    function ii(n) {
        var t, r, i, e, o, u, c, a, l, f, s = 150, g = 480, v = 250, d = 0, E = 0, y = 0, S = 0, m = 0, M = 0, x = null,
            _ = yt, w = null, R = Xt, C = .5;
        ...
        function j() {
            var n = ti(s, 0, 0, M).apply(null, t(d, E)), i = (M ? ti : function (n, t, r) {
                function i(i, e) {
                    return [t + n * i, r - n * e]
                }
    ...
    function li(n) {
        return function (t, r) {
            var i = N(t * t + r * r), e = n(i), o = x(e), u = E(e);
    ...
    function hi(n) {
        var t, r, i, e = ri(n), o = e.center, u = e.scale, c = e.translate, l = e.clipExtent, f = null;

        function s() {
            var o = a * u(), c = e(et(e.rotate()).invert([0, 0]));
    ...
    function vi(n, t) {
        var r = E(n), i = n === t ? x(n) : m(r / E(t)) / m(gi(t) / gi(n)), e = r * M(gi(n), i) / i;
        if (!i) return pi;
    ...
    function Ei(n, t) {
        var r = E(n), i = n === t ? x(n) : (r - E(t)) / (t - n), e = r / i + n;
        if (g(i) < u) return di;
    ...
    var yi = 1.340264, Si = -.081106, mi = 893e-6, Mi = .003796, xi = N(3) / 2;

    function _i(n, t) {
        var r = C(xi * x(t)), i = r * r, e = i * i * i;
    ...
    _i.invert = function (n, t) {
        ...
        var n, t, r, i, e, o, c = ci(), a = ui().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            l = ui().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
                point: function (n, t) {
                    o = [n, t]
                }
            };
        ...
        return s.invert = function (n) {
            var t = c.scale(), r = c.translate(), i = (n[0] - r[0]) / t, e = (n[1] - r[1]) / t;
        ...
        function u() {
            var u = r.apply(this, arguments), c = i.apply(this, arguments) * h, a = e.apply(this, arguments) * h;
        ...
        var n, t, r, i, e, o, u = 1, c = 0, a = 0, l = 1, f = 1, s = Xt, p = null, h = Xt;
        ...
        var r = n[0] * h, i = n[1] * h, e = t[0] * h, o = t[1] * h, u = E(i), c = x(i), a = E(o), l = x(o),
            f = u * E(r), s = u * x(r), g = a * E(e), v = a * x(e), y = 2 * C(N(P(o - i) + u * a * P(e - r))), S = x(y),
            m = y ? function (n) {
                var t = x(n *= y) / S, r = x(y - n) / S, i = r * f + t * g, e = r * s + t * v, o = r * c + t * l;
        ...
        var n = hi(Ai), t = n.center, r = n.rotate;
    ...
    }, n.geoTransverseMercatorRaw = Ai, Object.defineProperty(n, "__esModule", { value: !0 })
});
