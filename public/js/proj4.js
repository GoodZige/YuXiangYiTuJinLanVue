!function (t, s) {
    ...
    function Projection(s, i) {
        ...
        if ("object" == typeof a) {
            ...
            if (h) {
                ...
                var n = x(a.a, a.b, a.rf, a.ellps, a.sphere), r = y(n.a, n.b, n.rf, a.R_A), o = v(a.nadgrids),
    ...
    function L(t, s, i) {
        if (s === ft) return {x: t.x - i[0], y: t.y - i[1], z: t.z - i[2]};
        if (s === dt) {
            var a = i[0], h = i[1], e = i[2], n = i[3], r = i[4], o = i[5], l = i[6], u = (t.x - a) / l,
                c = (t.y - h) / l, M = (t.z - e) / l;
        ...
        for (var a = {x: -i.x, y: i.y}, h = {x: Number.NaN, y: Number.NaN}, e = [], n = 0; n < t.grids.length; n++) {
            ...
            if (null !== r.grid) {
                var o = r.grid.subgrids[0], l = (Math.abs(o.del[1]) + Math.abs(o.del[0])) / 1e4, u = o.ll[0] - l,
                    c = o.ll[1] - l, M = o.ll[0] + (o.lim[0] - 1) * o.del[0] + l,
    ...
    function Z(t) {
        ...
        var e, n, r, o, l, u, c, M, f = 6378137, d = (1 - Math.sqrt(.99330562)) / (1 + Math.sqrt(.99330562)),
            p = i - 5e5, m = s;
    ...
    var ft = 1, dt = 2, pt = 3, mt = 4, _t = 5, yt = 484813681109536e-20, xt = Math.PI / 2, gt = .16666666666666666,
    ...
    var as = function (t, s, i) {
            ...
            z(t.x), z(t.y)
        }, rs = Projection("WGS84"), os = 6, ls = "AJSAJS", us = "AFAFAF", cs = 65, Ms = 73, fs = 79, ds = 86, ps = 90,
        ms = {
    ...
    var _s = .01068115234375, ys = function (t) {
            ...
            init: function () {
                ...
                if (this.es) if (s = this.ml0 + n / this.k0, i = gs(s, this.es, this.en), Math.abs(i) < xt) {
                    var r = Math.sin(i), o = Math.cos(i), l = Math.abs(o) > wt ? Math.tan(i) : 0,
                        u = this.ep2 * Math.pow(o, 2), c = Math.pow(u, 2), M = Math.pow(l, 2), f = Math.pow(M, 2);
        ...
        ai = .0664021164021164, hi = .016415012942191543, ei = {
            ...
            init: function () {
                ...
                var s, i, a, h, e, n, r, o, l, u, c, M, f, d, p, m, _, y, x, g, v, b, w, N = t.x, A = t.y,
                    E = Math.sin(t.y), C = Math.cos(t.y), P = Ht(N - this.long0);
        ...
        Ni = {AREA_0: 1, AREA_1: 2, AREA_2: 3, AREA_3: 4}, Ai = {
            init: function () {
